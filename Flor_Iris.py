...
def user_input_features():
  ...
  petal_length_cm = st.number_input('Longitus del Pétalo:', min_value=1.0, max_value=7.0, value = 0, step = 0.1)
  petal_width_cm = st.number_input('Ancho del Pétalo:',min_value=0.0, max_value=3.0, value = 0, step = 0.1)
